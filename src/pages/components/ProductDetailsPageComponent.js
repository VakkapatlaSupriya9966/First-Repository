import { Col, Container, Row, Image, ListGroup, Button, Form, Alert } from "react-bootstrap";
...
const ProductDetailsPageComponent = ({
  ...
  return (
    ...
    <>
      <MetaComponet title={product.name} description={product.description} />
      <Container>
                  ...
                  <Col className="mt-5">
                    ...
                    <ListGroup variant="flush">
                      {product.reviews && product.reviews.map((review, idx) => (
                        <ListGroup.Item key={idx}>{review.user.name}
                          <br />
